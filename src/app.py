...
def create_app(config_instance=None):
    ...
    # DESHABILITADO - nginx maneja CORS
    # @app.before_request
    ...
    def not_found(error):
        ...
        """
        return jsonify({"error": "Endpoint no encontrado", "status": "error", "code": 404}), 404
    ...
    def internal_error(error):
        ...
        Returns:
            dict: Mensaje de error en formato JSON
        """
        return jsonify({"error": "Error interno del servidor", "status": "error", "code": 500}), 500
