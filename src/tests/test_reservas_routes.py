...
class TestCreateReservationEndpoint:
    ...
    def test_create_reservation_authenticated(
...
class TestCancelReservationEndpoint:
    ...
    @patch('reservas.routes.ReservaService')
    def test_cancel_reservation_authenticated(
        self, mock_service, client, auth_headers
    ):
...
class TestAdminEndpoints:
    ...
    @patch('reservas.routes.ReservaService')
    def test_get_pending_reservations_admin(
        self, mock_service, client, admin_auth_headers
    ):
    ...
    @patch('reservas.routes.ReservaService')
    def test_confirm_reservation_admin(
        self, mock_service, client, admin_auth_headers
    ):
    ...
    @patch('reservas.routes.ReservaService')
    def test_reject_reservation_admin(
        self, mock_service, client, admin_auth_headers
    ):
    ...
    @patch('reservas.routes.ReservaService')
    def test_confirm_non_existing_reservation(
        self, mock_service, client, admin_auth_headers
    ):
