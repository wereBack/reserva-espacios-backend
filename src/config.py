...
class Settings(PydanticBaseSettings):
    ...
    FLASK_SECRET_KEY: str = Field(
        "your-super-secret-key-please-change-me", description="Clave secreta para la aplicación."
    )
    ...
    FLASK_LOG_FILE: str | None = Field(default=None, description="Archivo de log")

    # Configuración de base de datos
    DATABASE_URL: PostgresDsn = Field(
        default="postgresql://postgres:postgres@localhost:5432/reserva_espacios_um",
